				...
				allDynamicIdentifiers.get(i).addActionListener(new ActionListener() {	
					...
					public void actionPerformed(ActionEvent actionEvent) {
						...
						if (allDynamicIdentifiers.get(currentCheckBoxIndex).isSelected()) {
									        ...
									        public void actionPerformed(ActionEvent e) {
									        	try {																        													        	
										        	...
										        	if (minValue <= maxValue) {
										        		...
										        		JOptionPane.showMessageDialog(Prism3Main.get_Prism_DesktopPane(), "'Min value' must be less than or equal to 'Max value'");														        																							
										        	}
							...
							int response = JOptionPane.showConfirmDialog(Prism3Main.get_Prism_DesktopPane(), popupPanel,
