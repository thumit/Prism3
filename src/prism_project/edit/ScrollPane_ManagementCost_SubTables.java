...
public class ScrollPane_ManagementCost_SubTables extends JScrollPane {		
	...
	public ScrollPane_ManagementCost_SubTables(JTable table8a, Object[][] data8a, String[] columnNames8a, JTable table8b, Object[][] data8b, String[] columnNames8b) {	
		...
		border = new TitledBorder("Conversion cost per converted area unit");
		border.setTitleJustification(TitledBorder.CENTER);
