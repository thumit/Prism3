...
public class QuickEdit_BasicConstraints_Panel extends JPanel {
	public QuickEdit_BasicConstraints_Panel(JTable table, Object[][] data) {
		...
		// Add button apply
		Spectrum_ApplyButton btnApply_multiplier = new Spectrum_ApplyButton(table, data, 3, multiplier_Textfield);		// 3 is the column to change
		c.gridx = 0;
		c.gridy = 3;
		c.weightx = 0;
		c.weighty = 0;
		...
		// Add JTextfield
		Spectrum_FormatedTextfield lowerbound_Textfield = new Spectrum_FormatedTextfield();
		c.gridx = 1;
		c.gridy = 5;
		c.weightx = 1;
		c.weighty = 0;
		...
		// Add button apply
		Spectrum_ApplyButton btnApply_lowerbound = new Spectrum_ApplyButton(table, data, 4, lowerbound_Textfield);		// 4 is the column to change
		c.gridx = 0;
		c.gridy = 5;
		c.weightx = 0;
		c.weighty = 0;
		...
		// Add JTextfield
		Spectrum_FormatedTextfield lbpenalty_Textfield = new Spectrum_FormatedTextfield();
		c.gridx = 1;
		c.gridy = 7;
		c.weightx = 1;
		c.weighty = 0;
		...
		// Add button apply
		Spectrum_ApplyButton btnApply_lbpenalty = new Spectrum_ApplyButton(table, data, 5, lbpenalty_Textfield);		// 5 is the column to change
		c.gridx = 0;
		c.gridy = 7;
		c.weightx = 0;
		c.weighty = 0;
		...
		// Add JTextfield
		Spectrum_FormatedTextfield upperbound_Textfield = new Spectrum_FormatedTextfield();
		c.gridx = 1;
		c.gridy = 9;
		c.weightx = 1;
		c.weighty = 0;
		...
		// Add button apply
		Spectrum_ApplyButton btnApply_upperbound = new Spectrum_ApplyButton(table, data, 6, upperbound_Textfield);		// 6 is the column to change
		c.gridx = 0;
		c.gridy = 9;
		c.weightx = 0;
		c.weighty = 0;
		...
		// Add JTextfield
		Spectrum_FormatedTextfield ubpenalty_Textfield = new Spectrum_FormatedTextfield();
		c.gridx = 1;
		c.gridy = 11;
		c.weightx = 1;
		c.weighty = 0;
		...
		// Add button apply
		Spectrum_ApplyButton btnApply_ubpenalty = new Spectrum_ApplyButton(table, data, 7, ubpenalty_Textfield);		// 7 is the column to change
		c.gridx = 0;
		c.gridy = 11;
		c.weightx = 0;
		c.weighty = 0;
