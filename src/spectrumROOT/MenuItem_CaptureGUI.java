...
import spectrumConvenienceClasses.ImageWhenClicked;

public class MenuItem_CaptureGUI extends JMenuItem {

	public MenuItem_CaptureGUI(Spectrum_Main main) {
				...
				Thread thread = new Thread() { // Make a thread to allow capture screen within 5 seconds
					public void run() {
						if (!this_menu_item.isSelected()) {
							...
							for (Component comp : getAllComponents(Spectrum_Main.get_main())) {
